...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto">Dashboard</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ consultations</span>
			</div>
		</div>
	</div>
	<!-- breadcrumb -->
				...
				<div class="card">
					<div class="card-header pb-0">
						<div class="d-flex justify-content-between">
							<h4 class="card-title mg-b-0">consultations TABLE</h4>
							...
							<table class="table text-md-nowrap" id="example1">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="consultations/{{$consultation->id}}" class="mx-1">
