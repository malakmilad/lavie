...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto">Dashboard</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ branches</span>
			</div>
		</div>
	</div>
	<!-- breadcrumb -->
				...
				<div class="card">
					<div class="card-header pb-0">
						<div class="d-flex justify-content-between">
							<h4 class="card-title mg-b-0">branches TABLE</h4>
							...
							<table class="table text-md-nowrap" id="example1">
								<thead>
									<tr>
										...
										<th class="all border-bottom-0">address</th>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="#" class="deleteRow mx-1" data-id="{{$branch->id}}"><i class="fa-solid fa-trash text-danger"></i></a>
											<a href="branches/{{$branch->id}}" class="mx-1"><i class="fa-solid fa-pen-to-square"></i></a>
										</td>
									</tr>
									@endforeach
								</tbody>
...
<script>
	...
	function deleteRecord(record_id) {
		...
		var ajaxPromise = ajaxRequest('POST', "{{url('admin/delete/branch')}}", {record_id: record_id});
