...
<!-- Favicon -->
<link rel="icon" href="{{URL::asset('admin/assets/img/brand/favicon.png')}}" type="image/png"/>
<!-- Icons css -->
...
<!-- Sidemenu css -->
<link rel="stylesheet" href="{{URL::asset('admin/assets/css/sidemenu.css')}}">
<!-- font-awesome -->
...
<!--- Dark-mode css -->
<link href="{{URL::asset('admin/assets/css/style-dark.css')}}" rel="stylesheet">
<!---Skinmodes css-->
