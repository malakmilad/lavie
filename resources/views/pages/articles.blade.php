        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    <h2 class="title">{{ __('Medical Articles') }}</h2>
                    <ul class="page-list">
                        <li class="rbt-breadcrumb-item"><a href="{{route('home')}}">{{ __('Home') }}</a></li>
                        <li>
                            <div class="icon-right"><i class="feather-chevron-right"></i></div>
                        </li>
                        <li class="rbt-breadcrumb-item active">{{ __('Medical Articles') }}</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mt--30">
                <div class="rbt-card variation-02 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        <h5 class="rbt-card-title"><a href="{{ url('article/' . $article->slug) }}">{{$article->$title}}</a></h5>
                        <p class="rbt-card-text">{{$article->$overview}}</p>
                        <div class="rbt-card-bottom">
                            <a class="transparent-button" href="{{ url('article/' . $article->slug) }}">{{ __('Read More') }}<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                        </div>
                    </div>
                </div>
            </div>
